...
HD_PWD='/home/younas/Documents/Vivado/hbm_module_2/hbm_module_2.runs/design_2_noc_tg_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_noc_tg_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_noc_tg_1_0.tcl

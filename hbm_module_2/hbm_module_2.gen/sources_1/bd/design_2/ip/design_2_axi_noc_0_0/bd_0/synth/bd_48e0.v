...
//--------------------------------------------------------------------------------
//Command: generate_target bd_48e0.bd
//Design : bd_48e0
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_48e0,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_48e0,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "design_2_axi_noc_0_0.hwdef" *) 
module bd_48e0
   (HBM00_AXI_araddr,
    HBM00_AXI_arburst,
    HBM00_AXI_arcache,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.ACLK0 CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.ACLK0, ASSOCIATED_BUSIF HBM00_AXI:HBM01_AXI:HBM02_AXI:HBM03_AXI, CLK_DOMAIN design_2_noc_clk_gen_0_axi_clk_0, FREQ_HZ 300000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input aclk0;
  ...
  (* DONT_TOUCH *) 
  bd_48e0_HBM00_AXI_nmu_0 HBM00_AXI_nmu
       (.IF_NOC_AXI_ARADDR(HBM00_AXI_araddr),
        ...
        .aclk(aclk0));
  (* DONT_TOUCH *) 
  bd_48e0_HBM01_AXI_nmu_0 HBM01_AXI_nmu
       (.IF_NOC_AXI_ARADDR(HBM01_AXI_araddr),
        ...
        .aclk(aclk0));
  (* DONT_TOUCH *) 
  bd_48e0_HBM02_AXI_nmu_0 HBM02_AXI_nmu
       (.IF_NOC_AXI_ARADDR(HBM02_AXI_araddr),
        ...
        .aclk(aclk0));
  (* DONT_TOUCH *) 
  bd_48e0_HBM03_AXI_nmu_0 HBM03_AXI_nmu
       (.IF_NOC_AXI_ARADDR(HBM03_AXI_araddr),
        ...
        .aclk(aclk0));
  (* DONT_TOUCH *) 
  bd_48e0_MC_hbmc_0 MC_hbmc
       ();
  (* DONT_TOUCH *) 
  bd_48e0_const_0_0 const_0
       (.dout(const_0_dout));
endmodule

...
//
//**********************************************************************
#ifndef bd_48e0_MC_hbmc_0_core_h_
#define bd_48e0_MC_hbmc_0_core_h_

#include "NOCHbmMcXtlm.h"
#include "properties.h"

class bd_48e0_MC_hbmc_0_core : public NOCHbmMcXtlm
{
public:
  bd_48e0_MC_hbmc_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  : NOCHbmMcXtlm(nm, props)
  {
  }

  virtual ~bd_48e0_MC_hbmc_0_core()
  {
  }

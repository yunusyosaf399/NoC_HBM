...
//
//**********************************************************************
#ifndef _bd_48e0_HBM01_AXI_nmu_0_core_h_
#define _bd_48e0_HBM01_AXI_nmu_0_core_h_

#include "NOCMasterUnitXtlm.h"
#include "properties.h"

class bd_48e0_HBM01_AXI_nmu_0_core : public NOCMasterUnitXtlm
{
public:
...
bd_48e0_HBM01_AXI_nmu_0_core( sc_core::sc_module_name nm, const xsc::common_cpp::properties& props )
  ...
  virtual ~bd_48e0_HBM01_AXI_nmu_0_core() = default;
...
public: // stub pin-to-pin RTL interface
  ...
  sc_in< sc_bv<3> > NMU_WR_USR_DST;
  sc_in< sc_bv<3> > NMU_RD_USR_DST;

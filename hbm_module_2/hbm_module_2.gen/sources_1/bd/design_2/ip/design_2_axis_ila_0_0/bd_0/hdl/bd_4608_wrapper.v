...
//--------------------------------------------------------------------------------
//Command: generate_target bd_4608_wrapper.bd
//Design : bd_4608_wrapper
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

module bd_4608_wrapper
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arburst,
    SLOT_0_AXI_arcache,
    SLOT_0_AXI_arid,
  ...
  input [6:0]SLOT_0_AXI_bid;
  input SLOT_0_AXI_bready;
  input [1:0]SLOT_0_AXI_bresp;
  input [15:0]SLOT_0_AXI_buser;
  input SLOT_0_AXI_bvalid;
  input [255:0]SLOT_0_AXI_rdata;
  input [6:0]SLOT_0_AXI_rid;

...
//--------------------------------------------------------------------------------
//Command: generate_target bd_4608.bd
//Design : bd_4608
//Purpose: IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "bd_4608,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_4608,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=59,numReposBlks=59,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=None}" *) (* HW_HANDOFF = "design_2_axis_ila_0_0.hwdef" *) 
module bd_4608
   (SLOT_0_AXI_araddr,
    SLOT_0_AXI_arburst,
    SLOT_0_AXI_arcache,
    ...
    clk,
    resetn);
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARADDR" *) (* X_INTERFACE_MODE = "Monitor UndefinedType" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME SLOT_0_AXI, ADDR_WIDTH 64, ARUSER_WIDTH 16, AWUSER_WIDTH 16, BUSER_WIDTH 16, CLK_DOMAIN design_2_noc_clk_gen_0_axi_clk_0, DATA_WIDTH 256, FREQ_HZ 300000000, HAS_BRESP 1, HAS_BURST 1, HAS_CACHE 1, HAS_LOCK 1, HAS_PROT 1, HAS_QOS 1, HAS_REGION 1, HAS_RRESP 1, HAS_WSTRB 1, ID_WIDTH 7, INSERT_VIP 0, MAX_BURST_LENGTH 256, NUM_READ_OUTSTANDING 2, NUM_READ_THREADS 1, NUM_WRITE_OUTSTANDING 2, NUM_WRITE_THREADS 1, PHASE 0.0, PROTOCOL AXI4, READ_WRITE_MODE READ_WRITE, RUSER_BITS_PER_BYTE 0, RUSER_WIDTH 16, SUPPORTS_NARROW_BURST 1, WUSER_BITS_PER_BYTE 0, WUSER_WIDTH 16" *) input [63:0]SLOT_0_AXI_araddr;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI ARID" *) input [6:0]SLOT_0_AXI_arid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI AWID" *) input [6:0]SLOT_0_AXI_awid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI BID" *) input [6:0]SLOT_0_AXI_bid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI BUSER" *) input [15:0]SLOT_0_AXI_buser;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI RID" *) input [6:0]SLOT_0_AXI_rid;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI WUSER" *) input [15:0]SLOT_0_AXI_wuser;
  (* X_INTERFACE_INFO = "xilinx.com:interface:aximm:1.0 SLOT_0_AXI WVALID" *) input SLOT_0_AXI_wvalid;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN design_2_noc_clk_gen_0_axi_clk_0, FREQ_HZ 300000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  (* X_INTERFACE_INFO = "xilinx.com:signal:reset:1.0 RST.RESETN RST" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME RST.RESETN, INSERT_VIP 0, POLARITY ACTIVE_LOW" *) input resetn;

  wire [63:0]SLOT_0_AXI_araddr;
  wire [1:0]SLOT_0_AXI_arburst;
  wire [3:0]SLOT_0_AXI_arcache;
  wire [6:0]SLOT_0_AXI_arid;
  ...
  wire [6:0]SLOT_0_AXI_bid;
  wire SLOT_0_AXI_bready;
  wire [1:0]SLOT_0_AXI_bresp;
  wire [15:0]SLOT_0_AXI_buser;
  wire SLOT_0_AXI_bvalid;
  wire [255:0]SLOT_0_AXI_rdata;
  wire [6:0]SLOT_0_AXI_rid;
  ...
  wire [15:0]axis_ila_pp_probe10_out;
  wire [63:0]axis_ila_pp_probe11_out;
  wire [1:0]axis_ila_pp_probe12_out;
  wire [3:0]axis_ila_pp_probe13_out;
  wire [6:0]axis_ila_pp_probe14_out;
  wire [7:0]axis_ila_pp_probe15_out;
  wire [0:0]axis_ila_pp_probe16_out;
  wire [2:0]axis_ila_pp_probe17_out;
  wire [3:0]axis_ila_pp_probe18_out;
  wire [3:0]axis_ila_pp_probe19_out;
  wire [1:0]axis_ila_pp_probe1_out;
  wire [2:0]axis_ila_pp_probe20_out;
  wire [15:0]axis_ila_pp_probe21_out;
  wire [6:0]axis_ila_pp_probe22_out;
  wire [1:0]axis_ila_pp_probe23_out;
  wire [15:0]axis_ila_pp_probe24_out;
  wire [255:0]axis_ila_pp_probe25_out;
  wire [6:0]axis_ila_pp_probe26_out;
  wire [1:0]axis_ila_pp_probe27_out;
  wire [15:0]axis_ila_pp_probe28_out;
  wire [255:0]axis_ila_pp_probe29_out;
  wire [3:0]axis_ila_pp_probe2_out;
  wire [31:0]axis_ila_pp_probe30_out;
  wire [15:0]axis_ila_pp_probe31_out;
  wire [1:0]axis_ila_pp_probe32_out;
  wire [2:0]axis_ila_pp_probe33_out;
  wire [1:0]axis_ila_pp_probe34_out;
  wire [1:0]axis_ila_pp_probe35_out;
  wire [2:0]axis_ila_pp_probe36_out;
  wire [6:0]axis_ila_pp_probe3_out;
  wire [7:0]axis_ila_pp_probe4_out;
  ...
  wire [2:0]axis_ila_pp_probe9_out;
  ...
  wire axis_itct_cfg_din34;
  wire axis_itct_cfg_din35;
  wire axis_itct_cfg_din36;
  ...
  wire axis_itct_cfg_en34;
  wire axis_itct_cfg_en35;
  wire axis_itct_cfg_en36;
  ...
  wire [36:0]axis_itct_trigger_din;
  ...
  wire [14:0]axis_mem_trace_rd_wrd_cnt_o;
  ...
  wire axis_mu34_0_cfg_dout;
  wire axis_mu34_0_match_out;
  wire axis_mu35_0_cfg_dout;
  wire axis_mu35_0_match_out;
  wire axis_mu36_0_cfg_dout;
  wire axis_mu36_0_match_out;
  ...
  bd_4608_axis_cap_ctrl_0 axis_cap_ctrl
  ...
  bd_4608_axis_dbg_stub_0 axis_dbg_stub
  ...
  bd_4608_axis_itct_0 axis_itct
       (.app_spec_i(axis_ila_intf_app_spec_o),
        ...
        .cfg_din34(axis_itct_cfg_din34),
        .cfg_din35(axis_itct_cfg_din35),
        .cfg_din36(axis_itct_cfg_din36),
        ...
        .cfg_dout34(axis_mu34_0_cfg_dout),
        .cfg_dout35(axis_mu35_0_cfg_dout),
        .cfg_dout36(axis_mu36_0_cfg_dout),
        ...
        .cfg_en34(axis_itct_cfg_en34),
        .cfg_en35(axis_itct_cfg_en35),
        .cfg_en36(axis_itct_cfg_en36),
        ...
        .match_out34(axis_mu34_0_match_out),
        .match_out35(axis_mu35_0_match_out),
        .match_out36(axis_mu36_0_match_out),
  ...
  bd_4608_axis_mem_0 axis_mem
       (.ADDR_WRITE_I(axis_cap_ctrl_addr),
        ...
        .probe34(axis_ila_pp_probe34_out),
        .probe35(axis_ila_pp_probe35_out),
        .probe36(axis_ila_pp_probe36_out),
  ...
  bd_4608_axis_mu0_0_0 axis_mu0_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu10_0_0 axis_mu10_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu11_0_0 axis_mu11_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu12_0_0 axis_mu12_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu13_0_0 axis_mu13_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu14_0_0 axis_mu14_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu15_0_0 axis_mu15_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu16_0_0 axis_mu16_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu17_0_0 axis_mu17_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu18_0_0 axis_mu18_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu19_0_0 axis_mu19_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu1_0_0 axis_mu1_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu20_0_0 axis_mu20_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu21_0_0 axis_mu21_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu22_0_0 axis_mu22_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu23_0_0 axis_mu23_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu24_0_0 axis_mu24_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu25_0_0 axis_mu25_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu26_0_0 axis_mu26_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu27_0_0 axis_mu27_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu28_0_0 axis_mu28_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu29_0_0 axis_mu29_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu2_0_0 axis_mu2_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu30_0_0 axis_mu30_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu31_0_0 axis_mu31_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu32_0_0 axis_mu32_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu33_0_0 axis_mu33_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu34_0_0 axis_mu34_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        .cfg_din(axis_itct_cfg_din34),
        .cfg_dout(axis_mu34_0_cfg_dout),
        .cfg_en(axis_itct_cfg_en34),
        .clk(clk),
        .data_in(axis_ila_pp_probe34_out),
        .ila_resetn(axis_ila_intf_aresetn_out),
        .match_out(axis_mu34_0_match_out),
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu35_0_0 axis_mu35_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        .cfg_din(axis_itct_cfg_din35),
        .cfg_dout(axis_mu35_0_cfg_dout),
        .cfg_en(axis_itct_cfg_en35),
        .clk(clk),
        .data_in(axis_ila_pp_probe35_out),
        .ila_resetn(axis_ila_intf_aresetn_out),
        .match_out(axis_mu35_0_match_out),
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu36_0_0 axis_mu36_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        .cfg_din(axis_itct_cfg_din36),
        .cfg_dout(axis_mu36_0_cfg_dout),
        .cfg_en(axis_itct_cfg_en36),
        .clk(clk),
        .data_in(axis_ila_pp_probe36_out),
        .ila_resetn(axis_ila_intf_aresetn_out),
        .match_out(axis_mu36_0_match_out),
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu3_0_0 axis_mu3_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu4_0_0 axis_mu4_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu5_0_0 axis_mu5_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu6_0_0 axis_mu6_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu7_0_0 axis_mu7_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu8_0_0 axis_mu8_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_axis_mu9_0_0 axis_mu9_0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_cc_axis_mu0_0 cc_axis_mu0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_cc_axis_mu1_0 cc_axis_mu1
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_cc_axis_mu2_0 cc_axis_mu2
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_cc_axis_mu3_0 cc_axis_mu3
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_slot_0_ar_0 slot_0_ar
       (.In0(SLOT_0_AXI_arready),
        .In1(SLOT_0_AXI_arvalid),
        .dout(slot_0_ar_dout));
  bd_4608_slot_0_aw_0 slot_0_aw
       (.In0(SLOT_0_AXI_awready),
        .In1(SLOT_0_AXI_awvalid),
        .dout(slot_0_aw_dout));
  bd_4608_slot_0_b_0 slot_0_b
       (.In0(SLOT_0_AXI_bready),
        .In1(SLOT_0_AXI_bvalid),
        .dout(slot_0_b_dout));
  bd_4608_slot_0_r_0 slot_0_r
       (.In0(SLOT_0_AXI_rlast),
        .In1(SLOT_0_AXI_rready),
        .In2(SLOT_0_AXI_rvalid),
        .dout(slot_0_r_dout));
  bd_4608_slot_0_w_0 slot_0_w
       (.In0(SLOT_0_AXI_wlast),
        .In1(SLOT_0_AXI_wready),
        .In2(SLOT_0_AXI_wvalid),
        .dout(slot_0_w_dout));
  bd_4608_tc_axis_mu0_0 tc_axis_mu0
       (.arm(axis_ila_intf_arm_o),
        .cfg_clk(axis_dbg_stub_aclk_int),
        ...
        .resetn(axis_dbg_stub_aresetn_int));
  bd_4608_xlconstant_0 xlconstant

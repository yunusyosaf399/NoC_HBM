...
#create_generated_clock -divide_by 1 -name "design_2_noc_tg_0_pclk" -source [get_pins -hierarchical -filter { NAME =~  "*/pclk*" && PARENT_CELL =~  "*u_top_axi_mst" }] [get_pins -hierarchical -filter { NAME =~  "*/pclk*" && PARENT_CELL =~  "*u_top_axi_mst" }]


#create_generated_clock -divide_by 1 -name "design_2_noc_tg_0_aclk" -source [get_pins -hierarchical -filter { NAME =~  "*/clk*" && PARENT_CELL =~  "*u_top_axi_mst" }] [get_pins -hierarchical -filter { NAME =~  "*/clk*" && PARENT_CELL =~  "*u_top_axi_mst" }]

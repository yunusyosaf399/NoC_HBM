...
# set xvlog options
xvlog_opts="--incr --relax  -L uvm -L clk_gen_sim_v1_0_4 -L sim_trig_v1_0_13 -L axi4stream_vip_v1_1_19 -L axi_vip_v1_1_19 -L perf_axi_tg_v1_0_15 -L axi_pmon_v1_0_2 -L cpm5_v1_0_17 -L cpm4_v1_0_17 -L noc_nps4_v1_0_0 -L noc_nps6_v1_0_0 -L axis_vio_v1_0_12 -L noc_hbm_nmu_sim_v1_0_0 -L noc_nmu_sim_v1_0_0 -L noc_hbm_v1_0_1 -L smartconnect_v1_0 -L versal_cips_ps_vip_v1_0_11 -L xilinx_vip"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L noc_nps4_v1_0_0 -L noc_nps6_v1_0_0 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot xlnoc xil_defaultlib.xlnoc xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim xlnoc -key {Behavioral:sim_1:Functional:xlnoc} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_8be5.protoinst" -protoinst "protoinst_files/bd_70da.protoinst" -protoinst "protoinst_files/bd_450b.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/xlnoc.protoinst" -log simulate.log
}

...
set genomeRtd $env(RT_TMP)/9F3F6BC0.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {design_1_noc_tg_3_0_reg_space__GB2}]"
...
set genomeName [subst -nocommands -novariables {design_1_noc_tg_3_0_reg_space__GB2}]

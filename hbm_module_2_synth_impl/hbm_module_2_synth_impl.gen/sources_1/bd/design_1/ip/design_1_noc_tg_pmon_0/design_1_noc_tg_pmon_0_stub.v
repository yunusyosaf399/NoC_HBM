...
// Date        : Sun May  4 19:09:55 2025
// Host        : younas-Latitude-7280 running 64-bit Ubuntu 20.04.6 LTS
// Command     : write_verilog -force -mode synth_stub
//               /home/younas/Documents/Vivado/hbm_module_2_synth_impl/hbm_module_2_synth_impl.gen/sources_1/bd/design_1/ip/design_1_noc_tg_pmon_0/design_1_noc_tg_pmon_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_noc_tg_pmon_0,axi_pmon_v1_0_2,{}" *) (* CORE_GENERATION_INFO = "design_1_noc_tg_pmon_0,axi_pmon_v1_0_2,{x_ipProduct=Vivado 2024.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_pmon,x_ipVersion=1.0,x_ipCoreRevision=2,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_AXI_PROTOCOL=AXI4,C_AXIS_TDATA_WIDTH=512,C_AXIS_TID_WIDTH=16,C_AXIS_TDEST_WIDTH=12,C_AXIS_TUSER_WIDTH=64,C_AXIS_TSTRB_WIDTH=64,C_AXIS_TKEEP_WIDTH=64,C_AXI_ID_WIDTH=7,C_AXI_ADDR_WIDTH=64,C_AXI_DATA_WIDTH=256,SIMULATION=TRUE,PRINT_LATENCIES=OFF,tCK=3333,PARAM_AXI_TG_ID=0}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "axi_pmon_v1_0_2,Vivado 2024.2" *) 
module design_1_noc_tg_pmon_0(axi_arst_n, axi_aclk, axi_awid, axi_awaddr, 

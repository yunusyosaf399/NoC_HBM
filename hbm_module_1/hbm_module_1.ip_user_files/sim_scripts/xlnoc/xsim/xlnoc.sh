...
simulate()
{
  xsim xlnoc -key {Behavioral:sim_1:Functional:xlnoc} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_8be5.protoinst" -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/xlnoc.protoinst" -log simulate.log
}
